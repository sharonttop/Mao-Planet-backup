...
function BlogSection(props) {
  return (
    <>
      {/* PC */}
      <Container fluid id="blogSection" className="p-0 d-md-block d-none">
        <Row className="d-flex justify-content-center">
          <Link
            to="/bloglist"
            className="blogIntro col-md-4 mx-2 mt-5 p-3 d-flex"
          >
            <div className="blogIntroPic px-0">
              <img src={BlogPic1} alt="" />
            </div>
            <div className="col blogIntroText my-0 pr-0">
              <h6>養貓新手必備知識</h6>
              <p className="mb-0">
      ...
      {/* mobile: 套carousel */}
      <div fluid id="m-blogSection" classNmae="mt-3 p-0 d-md-none d-block">
        <MobileBlogSection />
      </div>
