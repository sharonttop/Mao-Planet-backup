        ...
        <MDBCarouselInner>
          <MDBRow>
            <MDBCarouselItem itemId="1">
              <MDBCol md="4">
                <MDBCard className="mt-4 mb-2">
                  <MDBCardImage className="m-blogIntroPic m-4" src={BlogPic1} />
                  <MDBCardBody>
                    <MDBCardTitle>養貓新手必備知識</MDBCardTitle>
                    <MDBCardText className="m-blogIntroText mb-4">
            ...
            <MDBCarouselItem itemId="2">
              <MDBCol md="4">
                <MDBCard className="mt-4 mb-2">
                  <MDBCardImage className="m-blogIntroPic m-4" src={BlogPic2} />
                  <MDBCardBody>
